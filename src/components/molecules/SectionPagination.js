  ...
  return (
    <div className="relative flex lg:justify-between justify-center items-center mt-8">
      ...
      <div className="sticky right-4">
        <Pagination
          innerClass="relative flex space-x-2"
          ...
          itemClass="lg:text-zinc-500 text-zinc-400 hover:bg-slate-50 rounded-md transition-all duration-300 ease-in-out lg:px-2 py-2 font-medium "
